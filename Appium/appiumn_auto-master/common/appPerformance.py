...
if __name__ == '__main__':
    print(top_cpu(devices="78a88b73",pkg_name="com.tencent.mm"))
    print(get_men(devices="78a88b73",pkg_name="com.tencent.mm"))
    print(get_fps(devices="78a88b73", pkg_name="com.tencent.mm"))
