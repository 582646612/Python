...
def Z_unlock(driver):
    ...
    num1x = x + width / 6
    num1y = y + height / 6
    unlock2 = TouchAction(driver).press(None, num1x, num1y).wait(200).move_to(None, width / 3, 0).wait(200).move_to(None,width / 3,0).wait(200).move_to(None,-width / 3, height / 3).wait(200).move_to(None,-width / 3, height / 3).wait(200).move_to(None,width / 3,0).wait(200).move_to(None,width / 3,0)
    unlock2.release()
...
def L_unlock(driver):
    ...
    num1x = x + width / 6
    num1y = y + height / 6
    unlock1 = TouchAction(driver).press(None, num1x, num1y).wait(200).move_to(None, width /3, 0).wait(200).move_to(None,width / 3,0).wait(200).move_to(None, 0, height / 3).wait(200).move_to(None, 0, height / 3).release()
    unlock1.perform()
