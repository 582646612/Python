#coding:utf-8
import re
print(re.match('www', 'www.runoob.com').span())  # re.match只匹配字符串的开始在起始位置匹配
print(re.match('com', 'www.runoob.com'))

print(re.search('www', 'www.runoob.com').span())  # re.search匹配整个字符串在起始位置匹配
...
re.findall(pattern, string[, flags])#返回一个列表
re.finditer(pattern, string[, flags])#迭代器返回
...
if __name__ == "__main__":
    ...
    print re.search(r, '35012419810131229')